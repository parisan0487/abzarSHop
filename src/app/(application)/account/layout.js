  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row-reverse mt-5 gap-6 font-gandom min-h-[70vh]">
        <aside className="w-full md:max-w-xs rounded-2xl shadow-md bg-[#20223a] p-4 max-h-[470px]">
          <div className="bg-purple-900 text-white text-center py-2 rounded-md font-bold mb-4">
          ...
          <ul className="space-y-3 text-right px-2">
                ...
                <Link
                  ...
                  className={`block px-3 py-2 rounded-md transition-all ${
                    pathname.startsWith(item.href)
                      ? "bg-[#00A693]/10 text-purple-700 font-bold"
            ...
            {user?.role === "admin" && (
              <li>
                <Link
                  href="/adminPanel"
                  className="block px-3 py-2 rounded-md transition-all text-white hover:text-purple-700"
                >
                  پنل ادمین
                </Link>
              </li>
            ...
            <li>
              <button
                ...
                className="w-full text-right block px-3 py-2 rounded-md transition-all text-white hover:text-red-600"
              >
                خروج
              </button>
            </li>
        ...
        <main className="flex-1 bg-[#20223a] p-4 md:p-8 rounded-2xl shadow-md">
          {children}
        </main>
      </div>
    </>
